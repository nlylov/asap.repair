...
function reviewsSection(slug) {
  ...
  return `        <section class="svc-features" id="reviews" aria-label="Customer reviews">
            <div class="container">
                ...
                <h2 class="section-title">4.9★ Across <span class="text-accent">93 Verified Reviews</span></h2>
            ...
            <div class="container svc-hero__inner">
                ...
                <div class="svc-hero__trust">
                    <div class="trust-item"><svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                        ...
                        </svg>4.9★ · 93 Verified Reviews</div>
...
// The template emits the brand placeholder as og:image; the per-page photo card is
// stamped by generate-og-cards.mjs. Run it BEFORE the entity graph, which mirrors
