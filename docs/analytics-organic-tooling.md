...
- Ahrefs crawl: current 2026-07-03 crawl is still running; latest check showed 1,021 URLs crawled, 411 scheduled, and 96 billed pages. Wait for completion before treating issue counts as final.
- Bing Site Scan: `ASAP full site scan 2026-07-03 post-api-routing` is still queued after 34 minutes; no pages/errors/warnings are available yet.
