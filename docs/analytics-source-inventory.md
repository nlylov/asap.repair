...
- Internal-link graph on 2026-07-05: all six borough/Long Island landing pages were present in sitemap but had 0 raw-HTML inlinks before the service-area-link deploy. Homepage and `/services/` now expose visible static area links, local and live validation show each of the six area pages has 2 static inlinks, the post-deploy live crawl covered all 102 sitemap URLs with 0 technical issues, and IndexNow accepted the updated 102-URL set with HTTP `200 OK`.
