...
- Internal-link graph on 2026-07-05 before the service-area-link deploy: all six borough/Long Island landing pages were present in sitemap but had 0 raw-HTML inlinks. Homepage and `/services/` were updated to expose visible static area links, and local validation shows each of the six area pages now has 2 static inlinks.
