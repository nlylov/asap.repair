...
(function () {
    ...
    if (dateInput) {
        ...
        dateInput.addEventListener('change', async () => {
            ...
            try {
                ...
                const zipLbl = form.querySelector('#modal-zip')?.closest('.form-group')?.querySelector('.form-label');
    ...
    const CUSTOMER_API = 'https://crm.asap.repair/api/widget/check-customer';
